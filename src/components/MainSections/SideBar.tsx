...
const DarkModeIcon = (
  ...
  >
    <path
      d="M22 43.5C10.1259 43.5 0.5 33.8741 0.5 22C0.5 10.1259 10.1259 0.5 22 0.5C33.8741 0.5 43.5 10.1259 43.5 22C43.5 33.8741 33.8741 43.5 22 43.5Z"
      fill="#8E3EBB"
    />
    <path
      d="M22 43.5C10.1259 43.5 0.5 33.8741 0.5 22C0.5 10.1259 10.1259 0.5 22 0.5C33.8741 0.5 43.5 10.1259 43.5 22C43.5 33.8741 33.8741 43.5 22 43.5Z"
...
export default function SideBar() {
  return (
    <section className="flex flex-col items-start justify-end gap-4 w-[10%]">
      <DarkModeIcon />
      <SoundIcon />
      <SettingsIcon />
    </section>
